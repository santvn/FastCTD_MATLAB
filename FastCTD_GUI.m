...
if isempty(CondMax) || isnan(CondMax) || CondMax < 0 ||CondMax <= FastCTD_GUI_data.settings.CondMin{3}
...
if isempty(CondMin) || isnan(CondMin) || CondMin < 0 || CondMin >= FastCTD_GUI_data.settings.CondMax{3}
