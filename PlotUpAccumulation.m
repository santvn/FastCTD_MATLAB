clear;
matDataDir = '/Volumes/TTIDE2015_FCTD_Data/FCTD/MAT/';
rotDataDir = '/Volumes/TTIDE2015_FCTD_Data/FCTD/ROT/';
...
clf; 
plot(time-datenum(2015,02,00), tot_rot/pi/2,'linewidth',2)
grid on;
xlabel('Day in February');
ylabel('Number of rotations');
title('FCTD: Fish 2'' Rotation count on current line');
SN_setTextInterpreter;
SN_printfig([rotDataDir '/currentRotFig.pdf'],'fontsizeratio',1.5);
